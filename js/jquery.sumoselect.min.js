...
csvDispCount:7,// display no. of items in multiselect. 0 to display all.
captionFormat:"{0} 선택됨",// format of caption text. you can set your locale.
captionFormatAllSelected:"{0} 전체 선택됨",// format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
